...
% 				  \vspace*{.5\baselineskip}
				\includegraphics[width=.19\colwidth]{abb/6dimScheme.png}
			...
			\begin{minipage}[t]{.33\colwidth}
			  \begin{itemize}
				...
				\item[$\Rightarrow$] {\bf many trajectories} possible 
...
% 		  \end{minipage}
		  \begin{adjustbox}{valign=t}
			\begin{minipage}[t]{.19\colwidth}
			  \includegraphics[width=.20\colwidth]{abb/fig_1b.pdf}\vspace*{-0.7\baselineskip}\\
